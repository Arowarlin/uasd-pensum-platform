...
@Component({
  ...
  template: `
    ...
    <footer class="footer">
      ...
      <p class="autor">
        Estudiante: <strong>Arowarlin Suárez Díaz</strong>
  ...
  styles: [`
    ...
    .footer { background:#1a202c; color:rgba(255,255,255,0.6); text-align:center; padding:1rem 1rem 0.8rem; font-size:0.82rem; }
    .autor { font-size:0.78rem; color:rgba(255,255,255,0.45); margin-top:4px; }
    .autor strong { color:rgba(255,255,255,0.7); }
  `]
})
